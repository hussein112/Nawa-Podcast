...
const Podcast = ({ id, wpId, media }) => {
  ...
  return (
    <div className={"post post-single " + id + (media === "video" ? " border" : "")}>
        {media === "audio" ? <img src={require("../../assets/1.jpeg")} alt="a Post" className='bg' /> :
        ...
        {media === "audio" ? 
            <Audio url="audio.mp3" container={toggleContainer} color={id === 'even' ? '#016677' : '#D78079'} subtitlesOpacity={opacity} isSingle={false} />
        :
        <>
